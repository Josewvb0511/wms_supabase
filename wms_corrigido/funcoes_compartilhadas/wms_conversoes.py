...
from funcoes_compartilhadas.contexto_empresa import filtrar_df_empresas
...
def carregar_produtos_para_conversao() -> pd.DataFrame:
    ...
    for coluna in ["densidade", "peso_liquido", "custo_unitario"]:
    ...
    df_prod = df_prod.rename(
        columns={
            ...
            "custo_unitario": "custo_unitario_cadastro",
        }
    )
