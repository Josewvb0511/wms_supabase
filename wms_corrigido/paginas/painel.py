...
def app():
    ...
    try:
        df_prod = filtrar_df_empresas(conversa_banco.select("produtos", order_by="codigo"))
    except Exception:
        df_prod = filtrar_df_empresas(conversa_banco.select("produtos"))

    try:
        df_loc = filtrar_df_empresas(conversa_banco.select("localizacoes", order_by="codigo"))
    except Exception:
        df_loc = filtrar_df_empresas(conversa_banco.select("localizacoes"))
