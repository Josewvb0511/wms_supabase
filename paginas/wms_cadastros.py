...
def _aba_produtos():
    ...
    df = _normalizar_produtos(_select_seguro("produtos", order_by="codigo"))
...
def _aba_localizacoes():
    ...
    df = _normalizar_localizacoes(_select_seguro("localizacoes", order_by="setor"))
    ...
    colunas = ["id", "setor", "codigo", "local", "visualizacao", "ativo"]
